...
namespace toxico {
    ...
    public:
        ...
        /**
         * @brief Creates an ordered type key from a list of types.
         * 
         * @return The created ordered type key.
         */
        template<typename... Types>
        static OrderedTypeKey of() noexcept;

        /**
         * @brief Constructor.
         */
        OrderedTypeKey() noexcept = default;
         ...
         */
        bool operator==(const OrderedTypeKey& other) const;
...
#include "foundation/utility/OrderedTypeKey.tpp"
