...
Vector2 Camera::worldToScreen(Vector2 world, const Viewport& viewport) const {
    return {
...
Vector2 Camera::worldToScreen(Vector2 world) const {
    return worldToScreen(world, Services::renderer()->viewport());
}

Vector2 Camera::screenToWorld(Vector2 screen, const Viewport& viewport) const {
    return {
