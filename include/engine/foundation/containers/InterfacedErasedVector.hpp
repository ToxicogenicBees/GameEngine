/*
    InterfacedErasedVector.hpp

    Declaration of a type-erased collection of interfaced data, stored in {numerical index, value} pairs.
*/
...
namespace toxico {
    ...
    class InterfacedErasedVector {
    private:
        using Data = std::vector<std::unique_ptr<Interface>>;
        Data data_;
    ...
    public:
         ...
         * Throws an error if the index is out of bounds.
         */
        const Interface& at(std::size_t index) const;
        Interface& at(std::size_t index);
