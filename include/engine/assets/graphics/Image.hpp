...
namespace toxico {
    ...
    public:
        ...
        /**
         * @brief Fetches a list of all colors used in this image, in no particular order.
         * 
         * @return A list of all colors used in the image.
         */
        std::vector<Color4> colors() const noexcept;
...
#include "assets/graphics/Image.tpp"
